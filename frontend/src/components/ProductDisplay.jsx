        ...
        <div className="flex-col flex xl:flex-[1.5] bg-white px-6 py-2 rounded-xl">
          ...
          <div>
            <div className="flex flex-col sm:flex-row gap-x-10 gap-y-3 my-6">
              ...
              <div>
                ...
                <div className="flex gap-3 my-3">
                  <div className="ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer rounded-full bg-primary"></div>
                  <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-full bg-secondary"></div>
                  <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-full bg-tertiary"></div>
                  <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-full bg-quaternary"></div>
                </div>
              </div>
              <div>
                <h4 className="bold-16">Select Size:</h4>
                <div className="flex gap-3 my-3">
                  <div className="ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer rounded-md bg-tertiary text-white">
                    S
                  </div>
                  <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-md">
                    M
                  </div>
                  <div className="ring-2 ring-slate-900/10 h-10 w-10 flexCenter cursor-pointer rounded-md">
                    L
            ...
            <div className="flex gap-5 mb-8 max-w-[555px]">
              ...
              <button className="btn-dark-outline !rounded-md">
                Buy it now
              </button>
            </div>
            <p>
